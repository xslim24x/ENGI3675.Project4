//-----------------------------------------------------------------------
// <copyright file="safeinsert.aspx.cs" company="LakeheadU">
...
namespace Assign_4
{
    ...
    /// <summary>
    /// SafeInsert class responsible for displaying a webpage with the ability to insert into database
    /// </summary>
    public partial class SafeInsert : System.Web.UI.Page
    {
        /// <summary>
        ...
        {
            ServerConn.SafeAdd(this.sname.Text, float.Parse(this.sgpa.Text));
